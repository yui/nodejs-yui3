    ...
    */
    YUI.render = function(content, options) {
        ...
        if (options.isLayout) {
            ...
            if (locals.partial) {
                var str = locals.partial('layout_head');
                if (str) {
                    eY.one('head').prepend(str);
                }
                str = locals.partial('layout_prepend');
                if (str) {
                    eY.one('body').prepend(str);
                }
                str = locals.partial('layout_append');
                if (str) {
                    eY.one('body').append(str);
                }
            }
            var html = docType + "\n";
